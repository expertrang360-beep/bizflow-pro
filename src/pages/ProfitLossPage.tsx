...
export default function ProfitLossPage() {
  ...
  const fetchReport = async () => {
    setLoading(true);
    const [salesRes, saleItemsRes, expensesRes, payrollRes, assetsRes, taxRes] = await Promise.all([
    ...
    setData({ totalRevenue, costOfGoods, grossProfit, expenses: totalExpenses, payroll, depreciation, netProfitBeforeTax, vat, netProfit, expenseBreakdown });
    setLoading(false);
  };
